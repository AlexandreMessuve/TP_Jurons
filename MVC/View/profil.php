...
<?php session_start ()?>
  <div class="collapse" id="navbarToggleExternalContent">
    <div class="bg-dark p-4">
      ...
      <span class="badge text-bg-light"><?php  echo $_SESSION['donneesUtilisateur']['nom']?></span>
      <span class="badge text-bg-light"><?php  echo $_SESSION['donneesUtilisateur']['prenom']?></span>
      </div>
    </div>
  </div>
